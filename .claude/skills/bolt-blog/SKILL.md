...
**Read before writing anything:** the Bolt.new voice and editorial rules in `.claude/skills/bolt-TOV-and-guidelines/SKILL.md`. The AI-tell filter is its own skill, `noslops`, and runs as a mandatory pass (not an inline checklist). Everything in the TOV applies to blog content.
