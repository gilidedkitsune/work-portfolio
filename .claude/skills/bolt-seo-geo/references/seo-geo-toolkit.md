...
| Condition | Action |
|-----------|--------|
| Content type is blog, long-form, or website copy | Apply GEO/AEO rules from `.claude/skills/write-strike/references/SEO-GEO-drafting.md` while drafting. A drafting rule, not a post-draft skill. |
| Content type is ad copy | Run the Schwartz diagnosis from `.claude/skills/write-strike/references/schwartz-5x5-matrix.md` to set headline and lead strategy. Feeds the three-variant output. |
